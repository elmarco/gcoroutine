 ...
 */
#if (GCOROUTINE_MINOR_VERSION == 99)
# define GCOROUTINE_VERSION_CUR_STABLE    (_GCOROUTINE_ENCODE_VERSION (GCOROUTINE_MAJOR_VERSION + 1, 0))
#elif (GCOROUTINE_MINOR_VERSION % 2)
# define GCOROUTINE_VERSION_CUR_STABLE    (_GCOROUTINE_ENCODE_VERSION (GCOROUTINE_MAJOR_VERSION, GCOROUTINE_MINOR_VERSION + 1))
#else
# define GCOROUTINE_VERSION_CUR_STABLE    (_GCOROUTINE_ENCODE_VERSION (GCOROUTINE_MAJOR_VERSION, GCOROUTINE_MINOR_VERSION))
#endif

/* evaluates to the previous stable version */
#if (GCOROUTINE_MINOR_VERSION == 99)
# define GCOROUTINE_VERSION_PREV_STABLE   (_GCOROUTINE_ENCODE_VERSION (GCOROUTINE_MAJOR_VERSION + 1, 0))
#elif (GCOROUTINE_MINOR_VERSION % 2)
# define GCOROUTINE_VERSION_PREV_STABLE   (_GCOROUTINE_ENCODE_VERSION (GCOROUTINE_MAJOR_VERSION, GCOROUTINE_MINOR_VERSION - 1))
#else
# define GCOROUTINE_VERSION_PREV_STABLE   (_GCOROUTINE_ENCODE_VERSION (GCOROUTINE_MAJOR_VERSION, GCOROUTINE_MINOR_VERSION - 2))
#endif
...
# if GCOROUTINE_VERSION_MIN_REQUIRED > GCOROUTINE_VERSION_PREV_STABLE
#  define GCOROUTINE_VERSION_MAX_ALLOWED  (GCOROUTINE_VERSION_MIN_REQUIRED)
# else
#  define GCOROUTINE_VERSION_MAX_ALLOWED  (GCOROUTINE_VERSION_CUR_STABLE)
# endif
#endif
